                    ...
                    <tbody>
                        <tr>    
                            <td  colspan="2" scope="row" align="center" valign="center">
                                <div style="position: relative; width: 100%; height: 20px;"><p style="position: absolute;"><b>Liquidacion # {{$liquidacion->id}}</b></p></div>
                                <table class="table bordes mb-0">
                                    <tbody>
                                        <tr>
                                            <th  class="table-active bordes" scope="row">Estudiantes</th>
                                            <td>{{$inscripcion->pri_nombre}} {{$inscripcion->seg_nombre}} {{$inscripcion->pri_apellido}} {{$inscripcion->seg_apellido}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$inscripcion->direcion_recidencia }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{Helper::setNameProgramById($inscripcion->programa_id)}}</td>
                            ...
                            <th   colspan="2" scope="row">
                                <table class="table bordes  mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="3"   scope="row"> {{Helper::setNameProgramById($inscripcion->programa_id)}}</td>
                                            <td scope="row" colspan="3"  class=" bordes">$ {{str_replace(",",".",number_format($liquidacion->value))}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </th>
                        ...
                        <tr>
                            <th colspan="2" scope="row">  <table class="table bordes  mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" scope="row">{{$timeExpiration->format('Y/m/d')}}</td>
                                            <td scope="row"> PAGO ORDINARIO </td>
                                            <td scope="row"  class=" bordes">$ {{str_replace(",",".",number_format($liquidacion->value))}}</td>
                                        </tr>
                                    </tbody>
                                </table> 
                            </th>
                        ...
                        <tr>
                            <th colspan="2" scope="row">  <table class="table mb-0">
                                    <tbody>
                                        <tr>
                                            <td colspan="2"   scope="row" style="text-align: right;">HASTA {{$timeExpiration->format('Y/m/d')}}</td>
                                            <td  style="text-align: center;  scope="row"> TOTAL A PAGAR </td>
                                            <td    scope="row">$ {{str_replace(",",".",number_format($liquidacion->value))}}</td>
                                        </tr>
                                        <tr>
