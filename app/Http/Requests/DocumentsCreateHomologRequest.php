...
class DocumentsCreateHomologRequest extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            'resolución_y_acta_de_homologación' => 'required|max:20000|mimes:pdf',
            'certificado_de_notas' => 'required|max:20000|mimes:pdf',
            'contenido_tematico' => 'required|max:20000|mimes:pdf',
    ...
    public function messages() {
        return [
            ...
            'certificado_de_afiliacion_a_su_eps.required' => 'El campo ' . __('documentos.certificado_eps') . ' es requerido.',
            ...
            'resolución_y_acta_de_homologación.required' => 'El campo ' . __('documentos.resolucion_acta_homologacion') . ' es requerido.',
            'resolución_y_acta_de_homologación.mimes' => 'El campo ' . __('documentos.resolucion_acta_homologacion') . ' debe contener un archivo de formato PDF.',
            'resolución_y_acta_de_homologación.max' => 'El campo ' . __('documentos.resolucion_acta_homologacion') . ' el peso máximo para el archivo es de 20MG.',
            'certificado_de_notas.required' => 'El campo ' . __('documentos.certificado_notas') . ' es requerido.',
            'certificado_de_notas.mimes' => 'El campo ' . __('documentos.certificado_notas') . ' debe contener un archivo de formato PDF.',
            'certificado_de_notas.max' => 'El campo ' . __('documentos.certificado_notas') . ' el peso máximo para el archivo es de 20MG.',
            'contenido_tematico.required' => 'El campo ' . __('documentos.contenidos_tematicos') . ' es requerido.',
            'contenido_tematico.mimes' => 'El campo ' . __('documentos.contenidos_tematicos') . ' debe contener un archivo de formato PDF.',
            'contenido_tematico.max' => 'El campo ' . __('documentos.contenidos_tematicos') . ' el peso máximo para el archivo es de 20MG.',
